...
Fase 5 (AI), Fase 6 (pagamenti), Fase 7 (email), Fase 8 (sicurezza estesa), Fase 9
(infrastruttura), Fase 10 (performance), Fase 11 (lancio) — da eseguire un modulo alla volta,
come da preferenza espressa.
